...
public class TestMetier {
	...
	public static void testCrediterDebiterJoueur () {
		...
		try {
			...
			// crédit  de joueurs
			//System.out.println("********************************Acreditar jugadores******************************");
			...
			try {
				siteDeParisMetier.crediterJoueur(new String("Prou"), new String("Bernard"), new String("nanardd"), 1789, new String("ilesCaimans"));
				System.out.println("crediter joueur inexistant sans lever JoueurInexistantException");
			} 
			catch (JoueurInexistantException jie) { }
			catch (Exception e) { 
				System.out.println("crediter joueur inexistant sans lever JoueurInexistantException mais " + e.getClass().getName());
			}
			
			try {
				siteDeParisMetier.crediterJoueur(new String("Prouu*"), new String("Bernardd"), new String("nanardd"), 1789, new String("ilesCaimans"));
				System.out.println("crediter joueur avec un nom invalide sans lever JoueurException");
			} 
			catch (JoueurException je) { }
			catch (Exception e) { 
				System.out.println("crediter joueur avec un nom invalide sans lever JoueurException mais " + e.getClass().getName());
			}
			
			try {
				siteDeParisMetier.crediterJoueur(new String("Nadou"), new String("Sylvain"), new String("zinzin"), -1123, new String("ilesCaimans"));
				System.out.println("crediter joueur avec une somme en jetons negative sans lever MetierException");
			} 
			catch (MetierException me) { }
			catch (Exception e) { 
				System.out.println("crediter joueur avec une somme en jetons negative sans lever MetierException mais " + e.getClass().getName());
			}
			...
			try {
				siteDeParisMetier.debiterJoueur(new String("Nadou|"), new String("Sylvain"), new String("zinzin"), 2000, new String("ilesCaimans"));
				System.out.println("debiter joueur avec un nom invalide sans lever JoueurException");
			} 
			catch (JoueurException je) { }
			catch (Exception e) { 
				System.out.println("debiter joueur avec un nom invalide sans lever JoueurException mais " + e.getClass().getName());
			}
			
			
			try {
				siteDeParisMetier.debiterJoueur(new String("Nadou"), new String("Sylvain"), new String("zinzin"), 20000, new String("ilesCaimans"));
				System.out.println("debiter joueur avec une somme en jetons insuffisant sans lever JoueurException");
			} 
			catch (JoueurException je) {}
			catch (Exception e) { 
				System.out.println("debiter joueur avec une somme en  jetons insuffisant sans lever JoueurException mais " + e.getClass().getName());
			}
			
			try {
				siteDeParisMetier.debiterJoueur(new String("Eduardo"), new String("Sanchez"), new String("Argentino23"), 2, new String("ilesCaimans"));
				System.out.println("debiter joueur inexistant sans lever JoueurInexistantException");
			} 
			catch (JoueurInexistantException je) { }
			catch (Exception e) { 
				System.out.println("debiter joueur  inexistant sans lever JoueurInexistantException mais " + e.getClass().getName());
			}
	...
	public static void testMiserVainqueur () {
		...
		try {
			...
			try {
				siteDeParisMetier.miserVainqueur(new String("notbernard"), new String(passwdBernard), 40, new String("ChampionnatDeFrance2012"), new String("Lyon"));
				System.out.println("joueur inexistant a mise sans lever JoueurInexistantException");
			} 
			catch (JoueurInexistantException jie) { }
			catch (Exception e) { 
				System.out.println("joueur inexistant a mise sans lever sans lever JoueurInexistantException mais " + e.getClass().getName());
			}			
			
			try {
				siteDeParisMetier.miserVainqueur(new String("nanard"), new String(passwdBernard), 40, new String("BocaRiver"), new String("Lyon"));
				System.out.println("miser sur une competition inexistante sans lever CompetitionInexistanteException");
			} 
			catch (CompetitionInexistanteException cie) { }
			catch (Exception e) { 
				System.out.println("miser sur une competition inexistante sans lever CompetitionInexistanteException mais " + e.getClass().getName());
			}
			
			
			try {
				siteDeParisMetier.miserVainqueur(new String("nanard"), new String(passwdBernard), 40, new String("ChampionnatDeFrance2012"), new String("diallo"));
				System.out.println("miser sur une equipe inexistante sans lever CompetitionException");
			} 
			catch (CompetitionException ce) { }
			catch (Exception e) { 
				System.out.println("miser sur une equipe inexistante sans lever CompetitionException mais " + e.getClass().getName());
			}
			
			try {
				siteDeParisMetier.miserVainqueur(new String("nanard"), new String(passwdBernard), 444000, new String("ChampionnatDeFrance2012"), new String("Lyon"));
				System.out.println("commpte insuffisant sans lever JoueurException");
			} 
			catch (JoueurException je) {}
			catch (Exception e) { 
				System.out.println("commpte insuffisant sans lever JoueurException mais " + e.getClass().getName());
			}
		}
		catch (Exception e) {
			System.out.println("\n Exception imprévue : " + e);
	...
	public static void testSolderVainqueur () {
		...
		try {
			...
			//System.out.println("********************************Comienzan las apuestas******************************");
			...
			//Solido hasta este punto del codigo!!
		...
		try {
			...
			//System.out.println("Solidoooooooooooooooooooo");
		}
		catch (Exception e) {
			System.out.println("\n Exception imprévue : " + e);
			e.printStackTrace();
	...
	public static void testConsulterJoueurs () {
		...
		try {
			...
			//System.out.println("Solidoooooooooooooooooooosssssssssssssssssssssssss");
...
testConsulterJoueurs();		
		//done
System.out.println("Todos los test pasaron!!! Soy magico!!!!");
	}
